...
# Add customer Page
    ...
    lstnewsletterall_xpath="//ul[@id='SelectedNewsletterSubscriptionStoreIds_listbox']//li"
    lstnewsletter_teststore_xpath="//li[contains(text(),'Test store 2')]"
    lstnewsletter_your_store_xpath="//li[contains(text(),'Your store name')]"
    ...
    #     lstall=self.driver.find_elements_by_xpath(self.lstnewsletterall_xpath)
    #     for all in lstall:
    #         if all==news:
    #             self.driver.find_element_by_xpath(self.lstnewsletter_teststore_xpath).click()
    #         else:
    #             self.driver.find_element_by_xpath(self.lstnewsletter_your_store_xpath).click()
